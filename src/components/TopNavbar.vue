  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Ценники</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">ЧАВО</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Информация</a></li>
      </ul>
      <div class="flex-shrink-0 dropdown">
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2" style="">
          <li><router-link class="dropdown-item" to="/sign-in/">Вход в систему</router-link></li>
